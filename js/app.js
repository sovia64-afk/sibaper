...
(function () {
    ...
    async function saveData(
        ...
        document.dispatchEvent(new CustomEvent("sibaperDataChanged", {
            detail: { page }
        }));
    ...
    function renderRecord(
        ...
        const structureImageCandidates = [
            record.file,
            record.fileData,
            record.fileUrl,
            record.filePublicUrl
        ];
        const structureImageSource = structureImageCandidates.find(source =>
            typeof source === "string" &&
            (source.startsWith("data:image/") ||
                source.startsWith("blob:") ||
                isSafeUrl(source))
        ) || "";
        const isStructureImage =
            structurePages.includes(page) &&
            Boolean(structureImageSource);
        ...
        if (
            ...
            media = `
                ...
                <img
                    ...
                    src="${escapeHTML(structureImageSource)}"
                    alt="${escapeHTML(
                        record.judul
                    )}"
                >
    ...
    function renderDataPage(
        ...
        if ([
            "perencanaan-2025-program",
            "perencanaan-2025-pk",
            "perencanaan-2025-rencana-aksi",
            "perencanaan-2025-realisasi-pk",
            "perencanaan-2025-realisasi-rencana-aksi",
            "perencanaan-2026-sk",
            "perencanaan-2026-notulen",
            "perencanaan-2026-kwitansi",
            "perencanaan-2027",
            "realisasi-anggaran",
            "realisasi-pelra",
            "realisasi-rekomendasi-teknis",
